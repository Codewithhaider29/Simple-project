...
var gift_image_url = 'namlun1.jpg';
...
function init() {
  ...
  present.addEventListener("click", function(e){
    ...
    document.getElementById('card').classList.add('thiepshow');
    document.getElementById('book').classList.add('bookshow');
  }, false);
